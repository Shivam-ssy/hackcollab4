    ...
    <div className="bg-white overflow-hidden shadow rounded-lg">
      <div className="p-5">
        ...
        <div className="mt-3 flex items-center text-sm text-gray-500">
          ...
          <span>{event.startDate ? formatDate(event.startDate) : 'No date specified'}</span>
        </div>
        ...
        <div className="mt-2 flex items-center text-sm text-gray-500">
          ...
          <span>{event.maxTeamSize ? `Max Team Size: ${event.maxTeamSize}` : `Team Event`} • {event.registrationFee > 0 ? `$${event.registrationFee} Entry` : 'Free Entry'}</span>
        </div>
      </div>
